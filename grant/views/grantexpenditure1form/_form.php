...
?>
	...
	<h4>Please enter all the expenditure details of the project you have selected below</h4>

		 <?php echo $form->dropDownListRow($model, 'project_code', GxHtml::listDataEx(tukgrant1::model()->findAllAttributes(null, true)),array('prompt'=>'Select Project')); ?>
...
<div class="form-group">
    <div class="col-sm-offset-2 col-sm-10">
       ...
       'type' => 'warning', 
       'size' => 'medium', 
       'url' => array('grantexpenditure/admin'),
